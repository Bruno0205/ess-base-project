...
USERS_FILE_PATH = os.path.join(os.path.dirname(__file__), '..', '..', 'db', 'db_users.json')
...
class ReviewService(ReviewServiceMeta):
    ...
    @staticmethod
    def hide_review(cpf: str, comentario_id: int) -> HttpResponseModel:
