...
from src.schemas.usuario import User_Pessoa_Fisica, User_Pessoa_Juridica #Usuario
...
def getUserDB():
    ...
    with open(os.path.join(os.path.dirname(__file__), '../db/db_users.json'), 'r') as dbu:
        db = json.load(dbu)
    return db
